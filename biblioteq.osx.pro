...
install_name_tool1.extra     = install_name_tool -change /usr/local/Cellar/poppler/21.12.0/lib/libpoppler.116.dylib @executable_path/../Frameworks/libpoppler.116.dylib /Applications/BiblioteQ.d/BiblioteQ.app/Contents/Frameworks/libpoppler-qt5.1.dylib
