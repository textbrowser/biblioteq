...
install_name_tool2.extra = install_name_tool -change /usr/local/Cellar/poppler/22.05.0/lib/libpoppler.121.dylib @executable_path/../Frameworks/libpoppler.121.dylib /Applications/BiblioteQ.d/BiblioteQ.app/Contents/Frameworks/libpoppler-qt5.1.dylib
install_name_tool2.path  = .
install_name_tool3.extra = install_name_tool -change /usr/local/Cellar/poppler/22.05.0/lib/libpoppler.121.dylib @executable_path/../Frameworks/libpoppler.121.dylib /Applications/BiblioteQ.d/BiblioteQ.app/Contents/Frameworks/libpoppler-qt5.1.dylib
