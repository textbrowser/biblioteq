...
install_name_tool1.extra     = install_name_tool -change /usr/local/Cellar/poppler/0.77.0/lib/libpoppler.88.dylib @executable_path/../Frameworks/libpoppler.88.dylib /Applications/BiblioteQ.d/BiblioteQ.app/Contents/Frameworks/libpoppler-qt5.1.dylib
install_name_tool2.path      = .
install_name_tool2.extra     = install_name_tool -change /usr/local/Cellar/poppler/0.77.0/lib/libpoppler.88.dylib @executable_path/../Frameworks/libpoppler.88.dylib /Applications/BiblioteQ.d/BiblioteQ.app/Contents/Frameworks/libpoppler-qt5.1.dylib
