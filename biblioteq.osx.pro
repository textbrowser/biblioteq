...
install_name_tool1.extra     = install_name_tool -change /usr/local/Cellar/poppler/20.12.0/lib/libpoppler.105.dylib @executable_path/../Frameworks/libpoppler.105.dylib /Applications/BiblioteQ.d/BiblioteQ.app/Contents/Frameworks/libpoppler-qt5.1.dylib
install_name_tool1.path      = .
install_name_tool2.extra     = install_name_tool -change /usr/local/Cellar/poppler/20.12.0/lib/libpoppler.105.dylib @executable_path/../Frameworks/libpoppler.105.dylib /Applications/BiblioteQ.d/BiblioteQ.app/Contents/Frameworks/libpoppler-qt5.1.dylib
