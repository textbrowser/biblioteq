...
class biblioteq_misc_functions
{
 public:
  ...
  static QImage getImage
    (const QString &, const QString &, const QString &, const QSqlDatabase &);
  ...
  static QString getAbstractInfo
    (const QString &, const QString &, const QSqlDatabase &);
  static QString getAvailability
    (const QString &, const QSqlDatabase &, const QString &, QString &);
  static QString getColumnString
    (const QTableWidget *, const int, const QString &);
  static QString getColumnString(const QTableWidget *, const int, const int);
  static QString getMemberName
    (const QSqlDatabase &, const QString &, QString &);
  static QString getOID
    (const QString &, const QString &, const QSqlDatabase &, QString &);
  ...
  static QStringList getLocations
    (const QSqlDatabase &, const QString &, QString &);
  ...
  static QStringList getReservedItems
    (const QString &, const QSqlDatabase &, QString &);
  ...
  static bool hasMemberExpired
    (const QSqlDatabase &db, const QString &memberid, QString &errorstr);
  static bool isCheckedOut
    (const QSqlDatabase &, const QString &, const QString &, QString &);
  static bool isCopyAvailable
    (const QSqlDatabase &, const QString &, const QString &,
     const QString &, QString &);
  static bool isCopyCheckedOut
    (const QSqlDatabase &, const QString &, const QString &,
     const QString &, QString &);
  ...
  static int getMaxCopyNumber
    (const QSqlDatabase &, const QString &, const QString &, QString &);
  static int getMinimumDays(const QSqlDatabase &, const QString &, QString &);
  static int sqliteQuerySize
    (const QString &, const QMap<QString, QVariant> &, const QSqlDatabase &,
     const char *, const int);
  static int sqliteQuerySize
    (const QString &, const QSqlDatabase &, const char *, const int);
  static qint64 getMemberMatchCount
    (const QString &, const QString &, const QSqlDatabase &, QString &);
  ...
  static void DBAccount
    (const QString &, const QSqlDatabase &, const int, QString &,
     const QString & = "");
  static void center(QWidget *, QMainWindow *);
  static void createInitialCopies
    (QString const &, const int, const QSqlDatabase &, const QString &,
     QString &);
  static void exportPhotographs
    (const QSqlDatabase &, const QString &, const int, const QString &);
  static void grantPrivs
    (const QString &, const QString &, const QSqlDatabase &, QString &);
